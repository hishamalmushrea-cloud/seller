...
| `phrases-db.csv` | قاعدة البيانات العربية الكاملة (ID + عبارة + فصحى + دولة + لهجة + موقف + مخاطب + رسمية + ألفة + مزاح + شيوع + ملاحظات) |
| **`multilingual/`** | **الموسوعة الموازية 🇹🇷 التركية · 🇮🇩 الإندونيسية · 🇹🇯 الطاجيكية · 🇫🇷 الفرنسية** — معادل تداولي لا ترجمة حرفية + نطق + حوارات + قوالب + CSV |
...
## 7) الموسوعة الموازية (2026-08-18)

أُضيفت طبقة **غير مترجِمة حرفيًا** في [`multilingual/`](multilingual/README.md):

| لغة | الملف |
|---|---|
| المنهج والنطق | `multilingual/00-manhaj.md` |
| 🇹🇷 التركية | `multilingual/01-turki.md` |
| 🇮🇩 الإندونيسية | `multilingual/02-indunisi.md` |
| 🇹🇯 الطاجيكية | `multilingual/03-tajiki.md` |
| 🇫🇷 الفرنسية + الفرنكوفونية | `multilingual/04-faransi.md` |
| 🇬🇧🇺🇸 الإنجليزية UK/US | `multilingual/04b-inglizi.md` |
| جداول مقارنة | `multilingual/05-muqarana.md` |
| قوالب | `multilingual/06-qawalib.md` |
| حوارات | `multilingual/07-hiwarat.md` |
| قاموس قصير + ذخيرة بلا مقابل عربي | `multilingual/08-qamus.md` |
| محاذير ومصادر | `multilingual/09-tahthir-wa-masadir.md` |
| تمارين مواقف | `multilingual/10-tadrib.md` |
| قاعدة البيانات | `multilingual/phrases-ml.csv` |

المحتوى العربي في الملفات 01–15 و`phrases-db.csv` **باقٍ كما هو**. الطبقة الجديدة تعيد استخدام التصنيف A–K ورموز الشيوع وسلم الرسمية.
